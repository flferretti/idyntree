...
public:
    ...
    IDYNTREE_DEPRECATED_WITH_MSG("Please use the setter methods to specify the parameters of the "
                                 "joint")
    RevoluteSO2Joint(const LinkIndex link1,
    ...
    /**
     * Set the revolute axis of the joint, expressed in specified link frame, that is considered the
     * "child" frame regarding the sign of the axis.
     *
